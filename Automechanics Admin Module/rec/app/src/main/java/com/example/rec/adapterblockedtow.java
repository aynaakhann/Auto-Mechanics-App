...
public class adapterblockedtow extends FirebaseRecyclerAdapter<HelperTow, adapterblockedtow.myviewholder>
{
    private adapterblockedtow.myviewholder holder;
    private int position;
    private HelperTow modell;
    FirebaseAuth auth;

    Context context;
    adapterblockedtow adapterr;
    public adapterblockedtow(@NonNull FirebaseRecyclerOptions<HelperTow> options, Context context) {
        super(options);
        this.context = context;
    }
    public adapterblockedtow(@NonNull FirebaseRecyclerOptions<HelperTow> options, adapterblockedtow.myviewholder holder) {
        super(options);
        this.holder = holder;
    }

    public adapterblockedtow(@NonNull FirebaseRecyclerOptions<HelperTow> options) {
        super(options);
    }
    @Override
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new adapterblockedtow.myviewholder(view);
    }
    ...
    {
        TextView name,cnic,phone,shid,email,password,imgpath,shopname,shopreg,date,charges;
        ImageView img;
        public myviewholder(@NonNull View itemView)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(v.getContext(), blocked_tow_details.class);
