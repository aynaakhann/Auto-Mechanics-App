...
public class HelperMech {
    String mid,mname,mcnic,mage,mphone,memail,mpass,mimage,category,recimg,cnicfrontpic,cnicbackpic;
    HelperMech(){}

    public HelperMech(String mid, String mname, String mcnic, String mage, String mphone, String memail, String mpass, String mimage, String category, String recimg, String cnicfrontpic, String cnicbackpic) {
        this.mid = mid;
        this.mname = mname;
        this.mcnic = mcnic;
        this.mage = mage;
