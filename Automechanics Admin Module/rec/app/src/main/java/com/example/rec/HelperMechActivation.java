...
public class HelperMechActivation {
    String mid,mname,mcnic,mage,mphone,memail,mpass,mimage,category,recimg,cnicfrontpic,cnicbackpic,charges;
    HelperMechActivation(){

    }

    public HelperMechActivation(String mid, String mname, String mcnic, String mage, String mphone, String memail, String mpass, String mimage, String category, String recimg, String cnicfrontpic, String cnicbackpic, String charges) {
        this.mid = mid;
        this.mname = mname;
        this.mcnic = mcnic;
        this.mage = mage;
