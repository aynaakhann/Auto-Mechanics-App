...
public class adapterrequesttowactivation extends FirebaseRecyclerAdapter<HelperTow, adapterrequesttowactivation.myviewholder>
{
    private adapterrequesttowactivation.myviewholder holder;
    private int position;
    private HelperTow modell;
    FirebaseAuth auth;

    Context context;
    adapterrequesttowactivation adapterr;
    public adapterrequesttowactivation(@NonNull FirebaseRecyclerOptions<HelperTow> options, Context context) {
        super(options);
        this.context = context;
    }
    public adapterrequesttowactivation(@NonNull FirebaseRecyclerOptions<HelperTow> options, adapterrequesttowactivation.myviewholder holder) {
        super(options);
        this.holder = holder;
    }

    public adapterrequesttowactivation(@NonNull FirebaseRecyclerOptions<HelperTow> options) {
        super(options);
    }
    @Override
    protected void onBindViewHolder(@NonNull  myviewholder holder, int position, @NonNull HelperTow modell) {
        ...
        Picasso.get().load(modell.getReg_img().toString()).into(holder.img);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new adapterrequesttowactivation.myviewholder(view);
    }
        ...
        public myviewholder(@NonNull View itemView)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(v.getContext(), towactivation.class);
