...
public class
requesttowstatus extends AppCompatActivity {
       ...
       acceptbtn=findViewById(R.id.acceptrequest);
        ...
        acceptbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference re= FirebaseDatabase.getInstance().getReference("Admin").child("towing_requests");
                ...
                cu.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        Toast.makeText(requesttowstatus.this,"request accepted!", Toast.LENGTH_SHORT).show();
                        Intent intent =new Intent(requesttowstatus.this,MainActivity3.class);
