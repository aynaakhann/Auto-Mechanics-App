...
public class adapterrequesttowing extends FirebaseRecyclerAdapter<HelperTow, adapterrequesttowing.myviewholder>
{
    private adapterrequesttowing.myviewholder holder;
    private int position;
    private HelperTow modell;
    FirebaseAuth auth;

    Context context;
    adapterrequesttowing adapterr;
    public adapterrequesttowing(@NonNull FirebaseRecyclerOptions<HelperTow> options, Context context) {
        super(options);
        this.context = context;
    }
    public adapterrequesttowing(@NonNull FirebaseRecyclerOptions<HelperTow> options, adapterrequesttowing.myviewholder holder) {
        super(options);
        this.holder = holder;
    }

    public adapterrequesttowing(@NonNull FirebaseRecyclerOptions<HelperTow> options) {
        super(options);
    }
    @Override
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new adapterrequesttowing.myviewholder(view);
    }
        ...
        public myviewholder(@NonNull View itemView)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(v.getContext(), requesttowstatus.class);
