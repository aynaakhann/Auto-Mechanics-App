...
public class adaptertowservicehistory extends FirebaseRecyclerAdapter<HelperTow_complains, adaptertowservicehistory.myviewholder>
{
    ...
    public adaptertowservicehistory(@NonNull FirebaseRecyclerOptions<HelperTow_complains> options, Context context) {
        super(options);
        this.context = context;
    }

    public adaptertowservicehistory(@NonNull FirebaseRecyclerOptions<HelperTow_complains> options, myviewholder holder) {
        super(options);
        this.holder = holder;
    }
    public adaptertowservicehistory(@NonNull FirebaseRecyclerOptions<HelperTow_complains> options) {
        super(options);
    }
    @Override
    protected void onBindViewHolder(@NonNull  myviewholder holder, int position, @NonNull HelperTow_complains modell) {
        ...
        holder.servicename.setText("Towing Service");
