...
public class MechFeedbackforCustFragment extends Fragment {
    ...
    EditText feedback;
    String feedbackst;
    public MechFeedbackforCustFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_mech_feedbackfor_cust, container, false);
        textView =view.findViewById(R.id.textViewM);
        submit=view.findViewById(R.id.Mechsubmitfeedback);
        ...
        myRef.child("HistoryM").child(cID).child(userid).child("request_status").removeValue();
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Toast.makeText(requireContext(), "Feedback Submitted", Toast.LENGTH_SHORT).show();
                myRef.child("mech_requests").child(userid).child(cID).removeValue();
        ...
        rb=view.findViewById(R.id.MechratingBarforCust);
