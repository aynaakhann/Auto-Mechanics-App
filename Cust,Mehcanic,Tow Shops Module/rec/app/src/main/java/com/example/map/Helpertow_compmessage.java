...
public class Helpertow_compmessage {
    String shopid,cid,complain,statuscomplain, owner_name,owner_cnic,shop_name,shop_regno,owner_phone,owner_email,password,reg_img,rpayment,date;
    Helpertow_compmessage(){
    }

    public Helpertow_compmessage(String shopid, String cid, String complain, String statuscomplain, String owner_name, String owner_cnic, String shop_name, String shop_regno, String owner_phone, String owner_email, String password, String reg_img, String rpayment, String date) {
        this.shopid = shopid;
        this.cid = cid;
